<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Home.master" AutoEventWireup="true" CodeFile="updateproduct.aspx.cs" Inherits="Customer_updateproduct" %>
              ...
              <asp:Image ID="Image1" runat="server" CssClass="img-fluid" />
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p></p>
	             	...
	             	<asp:TextBox ID="TextBox1" runat="server" TextMode="Number" AutoPostBack="True" CssClass="auto-style2" Width="78px" OnTextChanged="TextBox1_TextChanged1"></asp:TextBox><span class="input-group-btn ml-2">
...
<div class="w-100">Total Amount : Rs <asp:Label ID="Label5" runat="server" Text=""></asp:Label></div>
          	...
          	<p>
              <asp:Button ID="Button1" runat="server" Text="Update" CssClass="btn btn-black py-3 px-5" OnClick="Button1_Click" /></p>
    			</div>
